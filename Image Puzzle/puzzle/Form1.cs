...
namespace WindowsFormsApplication1
{
    public partial class frmPuzzleGame : Form
    {
        ...
        private void btnShuffle_Click(object sender, EventArgs e)
        {
            ...
            {
                YesOrNo = MessageBox.Show("Yakin Ingin Mengulang ?", "Puzzle Gambar", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            }
            if (YesOrNo == DialogResult.Yes || lblTimeElapsed.Text == "00:00:00")
            {
                ...
                lblTimeElapsed.Text = "00:00:00";
                inmoves = 0;
                lblMovesMade.Text = "Banyak Klik : 0";
            }
        }

        private void AskPermissionBeforeQuite(object sender, FormClosingEventArgs e)
        {
            DialogResult YesOrNO = MessageBox.Show("Yakin Mau Udahan ?", "Puzzle Gambar", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void SwitchPictureBox(object sender, EventArgs e)
        {
            ...
            if (inNullSliceIndex != inPictureBoxIndex)
            {
                ...
                if (FourBrothers.Contains(inNullSliceIndex))
                {
                    ...
                    lblMovesMade.Text = "Banyak Klik : " + (++inmoves);
                    if (CheckWin())
                    {
                        timer.Stop();
                        (gbPuzzleBox.Controls[8] as PictureBox).Image = lstOriginalPictureList[8];
                        MessageBox.Show("SELAMAT !!\nPuzzle Terselesaikan\nWaktu Tempuh: : " + timer.Elapsed.ToString().Remove(8) + "\nTotal Banyak Klik : " + inmoves, "Puzzle Gambar");
                        inmoves = 0;
                        lblMovesMade.Text = "Banyak Klik : 0";
                        lblTimeElapsed.Text = "00:00:00";
                        timer.Reset();
        ...
        private void UpdateTimeElapsed(object sender, EventArgs e)
        {
            ...
            if (timer.Elapsed.Minutes.ToString() == "2")
            {
                ...
                inmoves = 0;
                btnPause.Enabled = false;
                MessageBox.Show("Waktu Habis\nSilahkan Coba Lagi", "Puzzle Gambar");
                Shuffle();
            }
        }
        ...
        private void caraBermainToolStripMenuItem_Click(object sender, EventArgs e)
        {
            panel3.Visible = true;
        ...
        private void tentangGameToolStripMenuItem_Click(object sender, EventArgs e)
        {
